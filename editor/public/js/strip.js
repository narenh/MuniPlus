...
import { store, edit, select, stationById, linesOf, lineById, esc, platformsOf, isMultilevel } from './store.js';
  ...
  ln.stationIds.forEach((sid, i) => {
    ...
    row.innerHTML = `
      ...
      <div class="stop-main">
        ...
        <div class="stop-meta">
          ${isMultilevel(st) ? `<span class="tag">${(st.exits || []).length} EXIT</span>` : ''}
